...
variable "tenant_id" {
  description = "(Required) Specifies the Azure Microsoft Entra tenant id."
  type = string
}
...
variable "kubelet_identity_client_id" {
  description = "(Required) Specifies the client id of the kubelet user-defined managed identity."
  type        = string
  default     = ""
}